...
export type OptionsFormProps = {
  id: string;
  onSubmit: SubmitHandler<OptionsFormInputs>;
};

export type OptionsFormInputs = {
  keysToSkip: string[];
  embeddedObjectKeys: { key: string; id: string }[];
  treatTypeChangeAsReplace: boolean;
};

export function OptionsForm({ id, onSubmit }: OptionsFormProps) {
